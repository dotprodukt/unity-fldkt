#ifndef __SDFSURFACESTANDARD_HLSL__
#define __SDFSURFACESTANDARD_HLSL__
	...
	out float dep : SV_DEPTH)
{
	...
	if (DEIntersect(i.oeye.xyz,odir,eps,t)) {
		...
		nor = normalize(__sdf_grad(i.opos.xyz, eps*t*4.0));
	...
	surf(i.opos.xyz, o);
	o.Occlusion *= __sdf_ao(i.opos.xyz,nor,eps*10.0);
